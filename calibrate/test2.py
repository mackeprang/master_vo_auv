...
mask = None
gps_pos_x = int(gps_pos_y + 400//2)
gps_pos_y = int(gps_pos_x + 480//2)
...
for i,frame in enumerate(filenames):
    ...
    canvas = auv.draw_path(canvas,path,scale=0.6,flipX=True,rotate=0,flipY=True)
